                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 30 – Just steps away from Vashi Railway Station 

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs offers accurate diagnostic services, including complete blood, hormonal, and urine tests, with fast results. Our health check-up packages provide a full picture of your health, keeping you informed and proactive.
                                    
                                    </p>

                                <p class="about-fore__top__text">
                                    Enjoy the convenience of free home blood collection within 60 minutes, and get your results online in 3-4 hours.
                                </p>
                                <strong>Book your test today with Pravi Labs in Sector 30, Vashi – your reliable diagnostic partner.
                                </strong>
