                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 18 – Near Vashi Railway Station 


                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 18, Vashi, provides a wide range of diagnostic services, including complete blood tests, hormonal tests, and urine tests, tailored to meet your health needs.
                                    Our personalized health check-up packages ensure you stay proactive and informed about your wellness.
                                    
                                </p>
                                <p class="about-fore__top__text">With Free Home Blood Collection in just 60 minutes, we make testing convenient and hassle-free from your home.
                                    As a leading pathology lab in Vashi, we deliver fast and accurate blood test results online within 3-4 hours.
                                    
                                </p>
                                <strong>Book your test today with Pravi Labs – reliable diagnostics, every time.
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 18</h3>
