                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs in Kopar Khairane, Sector 1 near Ghansoli Flyover</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 1, Kopar Khairane offers reliable <strong>diagnostic services</strong>  including Complete blood tests, urine tests, and hormonal tests to help you manage your health effectively. Our Comprehensive <strong>health check-up packages</strong>  are tailored to suit your wellness needs, making it easy to monitor your health regularly.</p>
                                <p class="about-fore__top__text">With our <strong>free home blood collection</strong>  service in just 60 minutes, testing is convenient and stress-free. Access your <strong>results online within 3-4 hours</strong> , ensuring quick and accurate health updates.</p>
                                <strong>Book your test today with Pravi Labs in Sector 1, Kopar Khairane – your trusted diagnostic partner.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in KoparKhairane Sector 1</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs_Ghansoli Flyover.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
