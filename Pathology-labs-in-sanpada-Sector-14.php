                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs in Sanpada, Sector 14 Near Palm Beach</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 14, Sanpada provides a range of diagnostic tests, including blood tests, urine tests, and hormonal evaluations, ensuring accurate results for your health needs. Our free home blood collection service offers you convenience and comfort, so you can focus on what matters most – your health.</p>
                                <p class="about-fore__top__text">With Comprehensive health check-up packages, we help you stay proactive about your well-being. Access your blood test results online within 3-4 hours for quick and efficient health management.</p>
                                <strong>Choose Pravi Labs in Sector 14, Sanpada – your trusted partner in diagnostics.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 14</h3>
