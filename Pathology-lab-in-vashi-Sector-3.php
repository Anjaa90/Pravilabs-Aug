                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 3 – Just Steps away from Inorbit Mall
                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 3, Vashi, offers a full range of diagnostic services, including complete blood tests, hormonal tests, and urine tests, ensuring accurate and timely results.
                                    Our health check-up packages are tailored to help you stay proactive about your wellness.
                                    
                                    
                                    </p>

                                <p class="about-fore__top__text">With Free Home Blood Collection in 60 minutes, we make testing simple and convenient, right from your home.
                                    As a trusted pathology lab in Vashi, we provide fast blood test results online within 3-4 hours.
                                </p>



                                <strong>Choose Pravi Labs in Sector 3, Vashi, for reliable and efficient diagnostics. Book your test now!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 3</h3>
            ...
            <div class="card card-image">
                <img src="assets\images\pravilabs slider _Inorbit Mall.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
