                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 23 – Near APMC Market, Vashi
                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 23, Vashi, delivers reliable diagnostic services, including complete blood tests, urine tests, and hormonal evaluations.
                                    Take advantage of our free home blood collection service, with samples picked up within 60 minutes, eliminating the need for a lab visit.
                                    </p>
                                    <p class="about-fore__top__text">Our health check-up packages are tailored to suit your wellness goals, providing a clear picture of your health.
                                        Receive fast and accurate test results online within 3-4 hours, ensuring timely access to your reports.
                                        </p>
                                        <strong>Trust Pravi Labs in Sector 23, Vashi – book your test today for dependable diagnostics!
                                        </strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 23</h3>
