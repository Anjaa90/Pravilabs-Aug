                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Wadala – Pratiksha Nagar


                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Pratiksha Nagar offers complete blood
                                    tests, urine tests, hormonal tests, and more with accuracy and dependability you can
                                    trust. Our tailored health check-up packages make staying proactive about your
                                    health simple and stress-free.


                                </p>
                                <p class="about-fore__top__text">With Free Home Blood Collection in just 60 minutes, we
                                    ensure convenient testing from the comfort of your home. As a leading pathology lab
                                    in Pratiksha Nagar, we deliver fast and precise blood test results online within 3-4
                                    hours.


                                </p>
                                <strong>Choose Pravi Labs in Wadala Pratiksha Nagar for trusted and efficient
                                    diagnostics. Book your test now!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Wadala – Pratiksha Nagar
                    </h3>
            ...
            <div class="card card-image">
                <img src="assets/images/NearPratikshaNagarWadala (1).jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
