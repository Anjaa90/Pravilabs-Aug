                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 10 near D Mart</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 10, Sanpada offers a wide range of tests, including Complete blood tests with precise results you can trust. Our free home blood collection service ensures testing is easy and convenient.</p>
                                <p class="about-fore__top__text">We also provide Comprehensive health check-up packages to suit your specific needs and help you stay proactive about your wellness. Get your blood test results online within 3-4 hours, giving you quick access to important health updates.</p>
                                <strong>Book your test with Pravi Labs in Sector 10, Sanpada – your health matters to us!</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 10</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs_D_Mart Sanpada.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
