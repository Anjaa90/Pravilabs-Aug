                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 1 – Near Sanpada Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 1, Sanpada provides complete blood tests, urine tests, hormonal tests, and more to help you stay healthy. With free home blood collection, we can collect in just 60 minutes</p>
                                <p class="about-fore__top__text">Our health check-up packages are made to fit your needs, helping you take care of your health easily. Get accurate blood test results online within 3-4 hours.</p>
                                <strong>Choose Pravi Labs in Sector 1, Sanpada – book your test today</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 1</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/Pravilabs_Sanpada Railway Station.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
