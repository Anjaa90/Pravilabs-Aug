                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 28 – Near Tilak College, Vashi 

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title --><p class="about-fore__top__text">Pravi Labs in Sector 28, Vashi, offers accurate blood tests, urine tests, hormonal tests, and more, tailored to your needs.
                                    Our health check-up packages help you stay proactive about your wellness.</p>
                                <p class="about-fore__top__text">Enjoy hassle-free testing with our free home blood collection service, with samples collected within 60 minutes.
                                    Get fast and reliable test results online within 3-4 hours.</p>
                                    <strong>Book your test today with Pravi Labs in Sector 28, Vashi – trusted diagnostics you can count on.
                                    </strong>
                                </p>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 28</h3>
            ...
            <div class="card card-image">
                <img src="assets\images\pravilabs Tilak clg Vashi.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
