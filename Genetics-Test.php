                ...
                <div class="container">
                    <div class="main-header__bootom__inner">
                        <nav class="main-header__nav main-menu">
                            <ul class="main-menu__list one-page-scroll-menu">
                                <li class="scrollToLink current"><a
                                        href="https://pravilabs.in/https://pravilabs.in/">Home</a></li>
                                <li class="scrollToLink"><a href="https://pravilabs.in/#about">About Us</a></li>
                                <li class="scrollToLink"><a href="https://pravilabs.in/#our_features">Advantage</a></li>
...
gap: 8px; /* Add space between buttons */
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Genetics Test</h2>
                    ...
                    <div class=" col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__single">
                                ...
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Genetics Test
                                </h3><!-- /.service-details__title -->
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>A genetic test is
                                    among the critical pathology tests list used to detect a wide range of
                                    conditions, including inherited diseases, chromosomal abnormalities, and even some
                                    types of
                                    cancer.
                                    Genetic testing is usually performed using a blood or saliva sample. The test
                                    results can take a few days to several weeks to obtain.
                                </p>
