                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 12 – Near Juhu Goan, Vashi

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 12, Vashi, offers complete blood tests, urine tests, hormonal tests, and more with accuracy and dependability you can trust.
                                    Our tailored health check-up packages make staying proactive about your health simple and stress-free.
                                    </p>  
                                <p class="about-fore__top__text">With Free Home Blood Collection in just 60 minutes, we ensure convenient testing from the comfort of your home.
                                    As a leading pathology lab in Vashi, we deliver fast and precise blood test results online within 3-4 hours.
   
                                </p>
                <strong>Choose Pravi Labs in Sector 12, Vashi, for trusted and efficient diagnostics. Book your test now!  </strong>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 12</h3>
                        ...
                        <div class="contact-two__right wow fadeInUp" data-wow-duration="700ms" data-wow-delay="700ms">
                            <div class="sec-title sec-title--two text-start wow fadeInUp" data-wow-duration='1500ms'>
                                <h6 class="sec-title__tagline"><img src="assets/images/shapes/sec-title-s-2.png"
                                        alt="Contact With Us" class="sec-title__img">Contact With Us</h6>
