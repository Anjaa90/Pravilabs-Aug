                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Kopar Khairane, Sector 19 near teen taki koparkhairane</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 19, Kopar Khairane provides a wide range of diagnostic services, including Complete blood tests, hormonal tests, and urine tests to keep you informed about your health.</p>
                                ...
                                <strong>Choose Pravi Labs in Sector 19, Kopar Khairane for trusted and convenient health diagnostics. Book your test today!</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in KoparKhairane Sector 19     </h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs _Near Teen Tanki Koperkhirane.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
