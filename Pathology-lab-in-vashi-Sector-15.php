                            ...
                            <div class="about-fore__left">
                                <div class="about-fore__top">
                                    <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                        ...
                                        <!-- /.sec-title__tagline -->
                                        <h1 class="sec-title__title">Pravi Labs Vashi, Sector 15 – Just Steps away from Vashi Mini Market

                                        </h1>
                                        <!-- /.sec-title__title -->
                                    </div><!-- /.sec-title -->
                                    <p class="about-fore__top__text">Pravi Labs in Sector 15, Vashi, provides a range of reliable services, including complete blood tests, urine tests, and hormonal tests, to support your health.
                                        Our health check-up packages are tailored to meet your needs, offering a clear understanding of your wellness.
                                    </p>
                                    <p class="about-fore__top__text">With Free Home Blood Collection in just 60 minutes, we make testing convenient and stress-free from your home.
                                        Receive fast and precise blood test results online within 3-4 hours for quick access to your reports
                                    </p>
                                    <strong>Choose Pravi Labs in Sector 15, Vashi – quality diagnostics made simple. Book your test today!
                                    </strong>
                                </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 15</h3>
            ...
            <div class="card card-image">
                <img src="assets\images\pravilabs_Mini Market.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
