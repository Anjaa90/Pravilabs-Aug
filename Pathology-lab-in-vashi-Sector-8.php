                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 8 – Near Sagar Vihar
                                ...
                                <p class="about-fore__top__text">Pravi Labs in Sector 8, Vashi, offers complete blood tests, urine tests, and hormonal tests to support your wellness journey.
                                    Our health check-up packages are customized to your needs, ensuring proactive health management.
                                    </p>

                                <p class="about-fore__top__text">
                                </p>
                                <strong>Choose Pravi Labs in Sector 8, Vashi – reliable diagnostics made simple.
                                </strong>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 8</h3>
            ...
            <div class="card card-image">
                <img src="assets\images\pravilabs_Sagar vihar.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
