                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 11 – Near Juhu Gaon
                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 11, Vashi, offers complete blood tests, urine tests, and hormonal tests with accurate and timely results to meet your health needs.
                                    Our health check-up packages provide a comprehensive view of your well-being, helping you stay proactive about your health.
                                    
                                    
                                    </p>

                                <p class="about-fore__top__text">Enjoy the convenience of Free Home Blood Collection within 60 minutes for a hassle-free testing experience.
                                    As a trusted pathology lab in Vashi, we deliver precise blood test results online within 3-4 hours.
                                </p>
                                <strong>Book your test today with Pravi Labs, Sector 11, Vashi – your health partner.
