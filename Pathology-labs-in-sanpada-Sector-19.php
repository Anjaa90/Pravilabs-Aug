                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 19 near Palm Beach Service Road</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 19, Sanpada offers a variety of tests, including blood tests, urine tests, and hormonal checks, to help you take care of your health. Our health check-up packages are made to fit your needs, giving you a complete view of your wellness.</p>
                                <p class="about-fore__top__text">With free home blood collection, you can get tested easily without leaving your home. We deliver fast and accurate results online within 3-4 hours, so you can make quick health decisions.</p>
                                <strong>Book your test today with Pravi Labs in Sector 19, Sanpada.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 19</h3>
