                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 17 – Near Vashi Bus Depot

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs offers a comprehensive range of diagnostic services, including complete blood tests, hormonal tests, urine tests, and more. Our certified lab provides personalized health check-up packages designed to suit your unique wellness needs.
                                    With our Free Home Blood Collection in just 60 minutes, you can enjoy hassle-free testing from the comfort of your home.
                                    
                                </p>
                                <p class="about-fore__top__text">As one of the leading pathology labs in Vashi, we guarantee fast and accurate blood tests results, delivered online within 3-4 hours for your convenience.

                                </p>
                                <strong>Book your test today with Pravi Labs – the trusted name in diagnostics.
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 17</h3>
            ...
            <div class="card card-image">
                <img src="assets\images\pravilabs_Bus depot Vashi.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
