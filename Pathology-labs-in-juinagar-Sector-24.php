                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Juinagar, Sector 24 near Juinagar Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 24, Juinagar offers a wide range of diagnostic tests, including blood tests, urine tests, and hormonal evaluations, ensuring accurate results for your health needs. Our health check-up packages are tailored to suit your wellness goals, making it easy to track your health.</p>
                                <p class="about-fore__top__text">With free home blood collection, testing is convenient and hassle-free from your home. Get fast blood test results online within 3-4 hours, ensuring timely access to your reports.</p>
                                <strong>Choose Pravi Labs in Sector 24, Juinagar – reliable diagnostics for better health. Book your test today!</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Juinagar Sector 24</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs _Juinager Railway Station.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
