                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 12</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 12, Sanpada offers a variety of diagnostic services with complete blood tests ensuring precise and reliable results. Take advantage of our free home blood collection service, making testing more convenient for you.</p>
                                <p class="about-fore__top__text">Our personalized health check-up packages are designed to meet your unique health requirements, helping you maintain a proactive approach to your well-being. Expect fast and accurate blood test results delivered online within 3-4 hours.</p>
                                <strong>Book your test today at Pravi Labs in Sector 12, Sanpada – where your health is our priority.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 12</h3>
