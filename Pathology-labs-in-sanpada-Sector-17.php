                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 17 Near Zudio Palm Beach Road</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 17, Sanpada offers a variety of tests, including blood tests, urine tests, and hormonal assessments, providing accurate and timely results to support your health. Our health check-up packages are designed to meet your unique needs, helping you stay informed and take control of your wellness.</p>
                                <p class="about-fore__top__text">Enjoy the ease of our free home blood collection service, making testing convenient and hassle-free. With results available online within 3-4 hours, we ensure you get the information you need, fast.</p>
                                <strong>Choose Pravi Labs in Sector 17, Sanpada – diagnostics made simple and reliable.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 17</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs slider _Zudio Palm Beach Road.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
