                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 13 – Just Steps away from Vashi Railway Station

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 13, Vashi, provides a wide range of diagnostic services, including complete blood tests, hormonal tests, and urine tests, with accurate and timely results.
                                    Our personalized health check-up packages cater to your unique wellness needs, ensuring a complete understanding of your health.
                                    
                                    </p>
                               
                                <p class="about-fore__top__text">Enjoy hassle-free testing with Free Home Blood Collection, where samples are collected from your home within 60 minutes.
                                    As a trusted pathology lab in Vashi, we deliver fast blood test results online within 3-4 hours for your convenience.
                                ...
                                <strong>Choose Pravi Labs in Sector 13, Vashi, for reliable diagnostics. Book your test now!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 13</h3>
            ...
            <div class="card card-image">
                <img src="assets\images\pravilabs _Vashi railway station.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
