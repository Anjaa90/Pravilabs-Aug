                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 16 – Located Near Vashi Bus Depot


                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 16, Vashi, offers diagnostic services like complete blood tests, urine tests, and hormonal tests, delivering results you can trust.
                                    Our health check-up packages are tailored to your wellness needs, helping you stay informed and proactive.
                                    
                                </p>
                                <p class="about-fore__top__text">Enjoy the ease of Free Home Blood Collection, with samples collected from your home in just 60 minutes.
                                    We provide fast and accurate blood test results online within 3-4 hours for your convenience.
                                    
                                </p>
                                <strong>Choose Pravi Labs in Sector 16, Vashi – your trusted partner in health diagnostics. Book your test today!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 16</h3>
