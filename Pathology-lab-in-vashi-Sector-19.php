                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 19 – Located Near APMC Market, Vashi


                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 19, Vashi, provides accurate and efficient diagnostic services, including complete blood tests, urine tests, and hormonal evaluations to meet your health needs.
                                    Enjoy the convenience of Free Home Blood Collection in just 60 minutes, ensuring hassle-free testing from the comfort of your home.
                                    
                                </p>
                                <p class="about-fore__top__text">Our tailored health check-up packages help you stay proactive about your wellness goals.
                                    Receive fast and precise blood test results online within 3-4 hours, giving you timely access to your reports.
                                    
                                </p>
                                <strong>Choose Pravi Labs in Sector 19, Vashi – trusted diagnostics for better health. Book your test today!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 19</h3>
            ...
            <div class="card card-image">
                <img src="assets\images\pravilabs _Apmc market.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
                            ...
                            <div class="contact-two__content">
                                ...
                                <ul class="contact-two__content__list list-unstyled">
                                    ...
                                    <li class="contact-two__content__list__item">
                                        ...
                                        <div class="contact-two__content__inner">
                                            <span class="contact-two__content__title">Call us now</span>
