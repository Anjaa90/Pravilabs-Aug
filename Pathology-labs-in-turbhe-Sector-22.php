                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Turbhe, Sector 22 near Turbhe Gaon</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 22, Turbhe provides a complete range of diagnostic services, including blood tests, urine tests, and hormonal tests for your health needs. Our comprehensive health check-up packages make it simple to monitor your wellness and stay proactive.</p>
                                <p class="about-fore__top__text">With free home blood collection within 60 minutes, we ensure a smooth and convenient testing experience. Get fast and accurate test results online within 3-4 hours, helping you make informed health decisions.</p>
                                <strong>Book your test today with Pravi Labs in Sector 22, Turbhe – accurate diagnostics you can trust.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Turbhe Sector 22</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs slide_Turbhe Gaon.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
