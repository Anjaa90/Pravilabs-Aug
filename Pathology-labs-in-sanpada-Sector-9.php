                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 9 Near Jeejabai Maidan</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sanpada, Sector 9 provides a variety of health tests, including complete blood tests, urine tests, and hormonal tests, designed to keep you healthy. Our free home blood collection service, with samples collected from your home in just 60 minutes.</p>
                                <p class="about-fore__top__text">Our Comprehensive health check-up packages to suit your needs, making it simple to track your wellness. Get fast blood test results online within 3-4 hours for quick health updates.</p>
                                <strong>Choose Pravi Labs in Sector 9, Sanpada – book your test today!</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 9</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs _Jeejabai Maidan.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
