                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 4 – Located Near Vashi Bus Depot
                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 4, Vashi, provides complete blood tests, hormonal evaluations, urine tests, and more with accuracy you can trust.
                                    Our health check-up packages offer a detailed understanding of your wellness, keeping you informed and proactive.
                                    
                                    
                                    </p>

                                <p class="about-fore__top__text">With Free Home Blood Collection in 60 minutes, we ensure hassle-free testing from the comfort of your home.
                                    As a trusted pathology lab in Vashi, we deliver fast and precise blood test results online within 3-4 hours.
                                </p>



                                <strong> Choose Pravi Labs in Sector 4, Vashi, for dependable diagnostics. Book your test today!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 4</h3>
