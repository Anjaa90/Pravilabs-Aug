                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 31 – Just steps away from Vashi Railway Station

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 31, Vashi, provides comprehensive diagnostic services, including complete blood tests, urine tests, and hormonal assessments, ensuring accurate results every time.
                                    Our customized health check-up packages help you stay proactive and informed about your health.
                                    
                                    
                                    
                                    </p>

                                <p class="about-fore__top__text">With our free home blood collection service, we offer a convenient experience, collecting samples from your home in just 60 minutes.
                                    Get your results online in 3-4 hours for quick and easy access.
                                    
                                </p>
                                <strong>Book your test today with Pravi Labs in Sector 31, Vashi – the reliable choice for your health.
