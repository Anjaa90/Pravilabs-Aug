                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 1 – Just Steps away from Vashi Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 1, Vashi, offers complete blood
                                    tests, hormonal tests, urine tests, and more to help you monitor your health
                                    effectively. Our health check-up packages provide a personalized approach to
                                    wellness, meeting your specific needs.</p>

                                <p class="about-fore__top__text">With Free Home Blood Collection in 60 minutes, we
                                    ensure hassle-free testing from home. As a leading pathology lab in Vashi, we
                                    deliver accurate blood test results online within 3-4 hours.
                                </p>



                                <strong>Choose Pravi Labs for fast, reliable diagnostics.
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab with home blood collection services in Vashi Sector 1</h3>
                    ...
                    <div class="col-lg-5">
                        <div class="contact-two__right wow fadeInUp" data-wow-duration="700ms" data-wow-delay="700ms">
                            <div class="sec-title sec-title--two text-start wow fadeInUp" data-wow-duration='1500ms'>
                                ...
                                <h5 style="color: #fff; padding: 10px;">Schedule Your Free Home Collection Today
                                    </h5>
                            </div>
