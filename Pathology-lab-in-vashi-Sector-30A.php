                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 30A – Just steps away from Vashi Railway Station

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs offers a wide range of diagnostic tests, including complete blood test, urine, and hormonal tests, providing accurate results quickly.
                                    Our health check-up packages make it easy to stay on top of your wellness.
                                 </p>

                                <p class="about-fore__top__text"> Enjoy the convenience of free home blood collection within 60 minutes, and get your results online within 3-4 hours.
                                </p>
                                <strong> Book your test today with Pravi Labs in Sector 30A, Vashi – reliable diagnostics at your doorstep.
