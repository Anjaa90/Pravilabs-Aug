                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs in Turbhe, Sector 24 near Turbhe Lake</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 24, Turbhe provides a wide range of diagnostic tests, including Complete blood tests, urine tests, and hormonal tests, ensuring accurate and timely results. Our Comprehensive health check-up packages are designed to keep you informed about your wellness and help you stay proactive.</p>
                                <p class="about-fore__top__text">With free home blood collection in just 60 minutes, testing is quick and hassle-free. Get your test results online within 3-4 hours, making it easy to access important health information.</p>
                                <strong>Book your test today with Pravi Labs in Sector 24, Turbhe – for reliable diagnostics and care.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Turbhe Sector 24</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/Pravilabs_Turbhe Lake.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
