                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 20 – Near APMC Market, Vashi
                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 20, Vashi, ensures quick and reliable health testing with services like complete blood tests, urine tests, and hormonal evaluations.
                                    Our free home blood collection service brings convenience to your doorstep, with samples collected in just 60 minutes.
                                    </p>
                                <p class="about-fore__top__text">Tailored health check-up packages help you monitor your wellness with ease.
                                    Receive fast and accurate blood test results online within 3-4 hours, saving you time and effort.                                    
                                    </p>
                                    <strong>Trust Pravi Labs in Sector 20, Vashi, for dependable diagnostics. Book your test today!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 20</h3>
