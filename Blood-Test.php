...
gap: 8px; /* Add space between buttons */
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Blood Tests</h2>
                    ...
                    <div class=" col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__single">
                                ...
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Blood Tests</h3>
                                <!-- /.service-details__title -->
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>Our pathology lab test list includes blood tests designed to assess your overall health and identify potential concerns. Your doctor will recommend the right tests based on your specific health needs. Common blood tests include:

                                    <ul>
                                        <li>Complete Blood Count (CBC) to detect anemia, infections, and other abnormalities.</li>
                                        <li>Lipid Profile to measure cholesterol and triglyceride levels.</li>
                                        <li>Fasting Glucose Test and Blood Sugar Level (HbA1c) for diabetes monitoring.</li>
                                        <li>Thyroid Function Test to assess thyroid health.</li>
                                        <li>Kidney Function Test (KFT) and Liver Function Test (LFT) for evaluating kidney and liver health.</li>
                                        <li>Malaria Testing for detecting malaria infections.</li>
                                        <li>Vitamin B12 and Vitamin D3 tests, along with a comprehensive range of Vitamin Tests to check for deficiencies.</li>
                                    </ul>
                                    <p>These comprehensive lab tests provide valuable insights to support proactive healthcare.</p>
