                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Wadala – Sion Koliwada
                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sion Koliwada offers complete blood
                                ...
                                <p class="about-fore__top__text">With Free Home Blood Collection in just 60 minutes, we
                                    ...
                                    in Wadala, we deliver fast and precise blood test results online within 3-4 hours.
                                </p>
                                <strong>Choose Pravi Labs in Sion Koliwada for trusted and efficient diagnostics. Book
                                    your test now!
                                </strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Wadala – Sion Koliwada
                    </h3>
            ...
            <div class="card card-image">
                <img src="assets/images/Sion Koliwada Wadala.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
