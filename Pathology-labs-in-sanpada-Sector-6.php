                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 6 Near Juinagar Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 6, Sanpada provides a variety of health tests, including blood tests, urine tests, and hormonal tests, designed to keep you healthy. With Free Home Blood Collection in 60 minutes, we ensure hassle-free testing from home.</p>
                                <p class="about-fore__top__text">Get fast blood test results online within 3-4 hours for quick health updates. Our health check-up packages are tailored to suit your needs, making it simple to track your wellness.</p>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 6</h3>
