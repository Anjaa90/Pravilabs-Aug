                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Juinagar, Sector 23 near Gaondevi Maidan, Juinagar</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 23, Juinagar provides a wide range of tests like blood tests, urine tests, and hormonal checks to help you manage your health. Our health check-up packages are designed to meet your needs and give you a clear picture of your wellness.</p>
                                <p class="about-fore__top__text">With free home blood collection, getting tested is easy and convenient from your home. We deliver quick and accurate results online within 3-4 hours, ensuring timely updates on your health.</p>
                                <strong>Book your test today with Pravi Labs in Sector 23, Juinagar – your partner in better health.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Juinagar Sector 23</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs_Gaondevi Maidan Juinager.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
