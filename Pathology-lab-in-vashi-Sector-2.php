                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 2 – Near Vashi Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 2, Vashi, offers complete blood tests, hormonal tests, urine tests, and more to help you manage your health.
                                    Our customized health check-up packages cater to your specific wellness goals.
                                    
                                    </p>

                                <p class="about-fore__top__text">With Free Home Blood Collection in 60 minutes, we provide hassle-free testing from home.
                                    As one of the top pathology labs in Vashi, we deliver fast and accurate blood test results online within 3-4 hours.
                                    
                                </p>



                                <strong>Book your test today with Pravi Labs – your reliable diagnostic partner in Sector 2, Vashi
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 2</h3>
