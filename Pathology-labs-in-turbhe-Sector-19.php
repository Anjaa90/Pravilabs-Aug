                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Welcome to Pravi Labs, Pathology Lab & Home Blood Collection. Sector 19 - Turbhe, Navi Mumbai</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">At Pravilabs, our certified pathology lab offers convenient home blood collection services for accurate lab tests. Our expert lab team ensures reliable blood test results delivered right to your doorstep, making your experience hassle-free and comfortable. Book your lab test appointment today.</p>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Turbhe Sector 19</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs slider 1 png.png" alt="Image 1" class="slider-image active"
                    class="lazyload">
