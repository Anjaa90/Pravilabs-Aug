                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 18 near Palm Beach Service Road</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 18, Sanpada provides a wide range of diagnostic services, including Complete blood tests, urine tests, and hormonal evaluations. We ensure fast and precise results to help you monitor your health effectively. Our Comprehensive health check-up packages are tailored to meet your individual needs, making it easy to stay proactive about your wellness </p>
                                <p class="about-fore__top__text">With our free home blood collection service, getting tested is simple and stress-free. Receive your results online within 3-4 hours, ensuring quick access to important health information.</p>
                                <strong>Book your test with Pravi Labs in Sector 18, Sanpada – diagnostics you can count on.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 18</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/Pravilabs_palm Beach Service Road.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
