                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Wadala (West) - Road (railway stn. West)
                                ...
                                <p class="about-fore__top__text">Pravi Labs in Road (railway stn. West) offers complete blood tests, urine tests, and hormonal tests to support your wellness journey. Our health check-up packages are customized to your needs, ensuring proactive health management.


                                </p>
                                <p class="about-fore__top__text">With Free Home Blood Collection in just 60 minutes, we ensure convenient testing from the comfort of your home. As a leading pathology lab in Road (railway stn. West), we deliver fast and precise blood test results online within 3-4 hours.



                                </p>
                                <strong>Choose Pravi Labs in Road (railway stn. West) – reliable diagnostics made simple.
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Wadala (West) - Road (railway stn. West)
                    </h3>
            ...
            <div class="card card-image">
                <img src="assets/images/RailwayStationWadala.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
