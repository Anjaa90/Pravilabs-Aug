    ...
    <div class="page-wrapper">
                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi labs Dadar - East

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Dadar (East) provides a wide range of
                                    diagnostic services, including complete blood tests, hormonal tests, and urine tests
                                    to keep you informed about your health.

                                </p>
                                <p class="about-fore__top__text">Our comprehensive health care packages are tailored to
                                    meet your wellness goals, ensuring proactive care. With free home blood collection
                                    and test results delivered online within 3-4 hours, we make testing simple and
                                    reliable.
                                </p>
                                <strong>Choose Pravi Labs in Dadar (East) for trusted and convenient health diagnostics.
        ...
        <div class="container-card">
            ...
            <div class="card card-image">
                <img src="assets/images/DadarEast.jpg" alt="Image 1" class="slider-image active" class="lazyload">
