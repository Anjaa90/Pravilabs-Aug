                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 7 – Near From Vashi Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 7, Vashi, offers complete blood tests, urine tests, and hormonal tests to support your health.
                                    Our health check-up packages provide insights into your wellness, tailored to your needs. </p>

                                <p class="about-fore__top__text">With Free Home Blood Collection in 60 minutes, testing is convenient and hassle-free.
                                    As a leading pathology lab in Vashi, we deliver accurate blood test results online within 3-4 hours.
                                </p>



                                <strong>Book your test with Pravi Labs in Sector 7, Vashi, today – reliable diagnostics made easy.
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 7</h3>
