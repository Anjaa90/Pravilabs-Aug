                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 29 – Near Juhu Gaon, Vashi

                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 29, Vashi, offers a wide range of services, including complete blood tests, urine tests, and hormonal assessments, providing accurate results to support your health.
                                    Our tailored health check-up packages make it easier to track your wellness.
                                    </p>
                                    <p class="about-fore__top__text">With our free home blood collection service, get tested conveniently from home, with samples collected within 60 minutes.
                                        Receive your blood test results online in just 3-4 hours.
                                        </p>
                                        <strong>
                                            Book your test today with Pravi Labs in Sector 29, Vashi – trusted diagnostics at your service.
                                        </strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 29</h3>
