                    ...
                    <ul class="list-unstyled topbar-one__info">
                        <li class="topbar-one__info__item">
                            ...
                            <span class="topbar-one__info__item__location">Serving Areas : Vashi, Sanpada, JuiNagar,
                                Turbhe, Koparkhairane and Wadala</span>
                        </li>
                        <li class="topbar-one__info__item">
                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Wadala - Truck Terminals
                                ...
                                <p class="about-fore__top__text">Pravi Labs in Truck Terminal offers complete blood tests, urine tests, hormonal tests, and more with accuracy and dependability you can trust. Our tailored health check-up packages make staying proactive about your health simple and stress-free.


                                </p>
                                <p class="about-fore__top__text">With Free Home Blood Collection in just 60 minutes, we ensure convenient testing from the comfort of your home. As a leading pathology lab in Truck Terminal, we deliver fast and precise blood test results online within 3-4 hours.



                                </p>
                                <strong>Choose Pravi Labs in Wadala Truck Terminal for trusted and efficient diagnostics. Book your test now!


                                </strong>
                            </div>
                            <div class="Test-section"
                                style="background-color: #f0f0f0; padding-top: 20px; padding-bottom: 20px;">
                                <div class="container">
                                    <div class="section-title text-center">
                                        <h2>Some of the Tests offered by Pravi Labs</h2>

                                        <p>Be it common and regular Tests or Specilized Tests, We offer Everything at
                                            Pravi Labs</p>
                                    </div>
                                ...
                                <br>
                                <p class="section-title text-center">Book your test with Pravi Labs today for fast,
                                    accurate results and free home blood collection!</p>
                            </div>
                            <br>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Wadala – Truck Terminals
                    </h3>
            ...
            <div class="card card-image">
                <img src="assets/images/TruckTerminalsWadala.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
                                ...
                                <ul class="contact-two__content__list list-unstyled">
                                    <li class="contact-two__content__list__item">
                                        ...
                                        <div class="contact-two__content__inner">
                                            <span class="contact-two__content__title">Have Questions? Call or WhatsApp
                                                Us </span>
