                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Kopar Khairane, Sector 4 near Kopar Khairane Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 4, Kopar Khairane provides a wide range of diagnostic services, including Complete blood tests, hormonal tests, and urine tests to keep you informed about your health.</p>
                                <p class="about-fore__top__text">Our Comprehensive health care packages are tailored to meet your wellness goals, ensuring proactive care. With free home blood collection and Tests results delivered online within 3-4 hours, we make testing simple and reliable.</p>
                                <strong>Choose Pravi Labs in Sector 4, Kopar Khairane for trusted and convenient health diagnostics. Book your test today!</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in KoparKhairane Sector 4</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs _Koparkhairane Railway Station.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
