                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs  Turbhe, Sector 21 near Turbhe Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 21, Turbhe offers a wide range of diagnostic services, including Complete blood tests, urine tests, and hormonal tests to support your health. Our comprehensive health care packages are designed to meet your wellness needs and help you stay proactive.</p>
                                <p class="about-fore__top__text">With our free home blood collection in just 60 minutes, testing becomes easy and hassle-free. Get fast and accurate results online within 3-4 hours, ensuring you can make timely health decisions.</p>
                                <strong>Book your test today with Pravi Labs, Sector 21, Turbhe – your trusted partner in diagnostics.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Turbhe Sector 21</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs slide_Turbhe Ralilway Station.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
