                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Turbhe, Sector 23 near Janta Market</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs  in Sector 23, Turbhe offers services like Complete blood tests, urine tests, and hormonal tests to help you manage your health. Our Comprehensive health check-up packages are tailored to your needs, making it easy to track your wellness.</p>
                                <p class="about-fore__top__text">With free home blood collection within 60 minutes, you can get tested conveniently from home. We provide quick and accurate test results online within 3-4 hours for timely health updates.</p>
                                <strong>Choose Pravi Labs in Sector 23, Turbhe – your trusted partner for diagnostics.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Turbhe Sector 23</h3>
