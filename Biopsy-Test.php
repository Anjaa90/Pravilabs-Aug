...
<body class="custom-cursor">
    ...
    <div class="main-header__middle">
        <div class="container">
            <div class="main-header__inner">
                ...
                <nav class="main-header__nav main-menu">
                    <ul class="main-menu__list one-page-scroll-menu">
                        <li class="scrollToLink current"><a href="https://pravilabs.in/https://pravilabs.in/">Home</a></li>
                        ...
                        <li class="scrollToLink"><a href="https://pravilabs.in/#testimonial">Testimonial</a></li>
    ...
    <div class="main-header__bootom">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Biopsy Test</h2>
                        ...
                        <div class="service-sidebar">
                            <div class="service-sidebar__single  wow fadeInUp" data-wow-delay='500ms'>
                                ...
                                <ul class="list-unstyled service-sidebar__nav">
                                    ...
                                    <li><a href="Biopsy-Test.php">Biopsy Test</a></li>
                    ...
                    <div class=" col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__single">
                                ...
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Biopsy Test</h3>
                                <!-- /.service-details__title -->
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>A biopsy is a
                                    medical test under the pathology tests list in which tissue or cells are removed
                                    from the body for examination. Biopsies are performed for many reasons, including
                                    diagnosing
                                    cancer, infections, and other conditions. 
                                </p>
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>The tissues or
                                    cells removed during a biopsy are examined under a microscope by a
                                    pathologist to determine if they are normal or abnormal. The biopsy report includes
                                    information
                                    about the type of tissue removed and any abnormal findings, if any.
                                </p>
                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>There are several
                                    types of biopsies depending on the location of the tissue or cells being
                                    removed.
                                </p>
