...
gap: 8px; /* Add space between buttons */
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Urine Test</h2>
                    ...
                    <div class=" col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__single">
                                ...
                                <h3 class="service-details__title wow fadeInUp" data-wow-delay='300ms'>Urine Tests</h3>
                                <!-- /.service-details__title -->

                                <p class="service-details__text wow fadeInUp" data-wow-delay='350ms'>Urine tests, including urinalysis and routine urine checks, are essential components of the pathology test list for a complete health checkup. These tests help identify potential issues with your kidneys or other organs, providing your doctor with critical information about your overall health
                                    There are two main types of urine tests: Dipstick tests and Microscopy. 
                                    <li>Dipstick Tests are quick and easy and can be done at your doctor&#39;s office or
                                        at home.
                                        They involve dipping a strip of paper into a sample of your urine and then
                                        checking the
                                        strip for colour changes. Based on the changes in the colour of the strip, the
                                        potential
                                        health condition is identified.</li>
                                    <li>Microscopy is a more detailed test involving looking at a sample of your urine
                                        under a
                                        microscope. It can be used to look for signs of infection, kidney disease, or
                                        other
                                        problems.</li>
                                </p>
                             ...
                             Schedule your urine test today for a thorough health assessment! Contact us to book your appointment and take the first step towards better health.
                            ...
                            <div class="service-details__single">
                                <div class="faq-page__accordion laboix-accrodion" data-grp-name="laboix-accrodion">
                                    ...
                                    <!-- <div class="accrodion">
                                        <div class="accrodion-title">
                                            <h4 class="accrodion-title__text">How is a urine sample collected?<span
                                                    class="accrodion-title__icon"></span></h4>
                                        
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p class="inner__text">There are many variations of passages of Lorem
                                                    Ipsum available, but the majority have suffered alteradution in some
                                                    form by injected humour, or randomised words which don't look even
                                                    slightly believable. If you are going There are many variations</p>
                                            </div>
                                        </div>
                                    </div> -->
                                </div>
