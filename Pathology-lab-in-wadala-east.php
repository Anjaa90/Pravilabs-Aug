    ...
    <div class="page-wrapper">
                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Wadala  -  East
                                    </h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Wadala (East) provides a wide range of diagnostic services, including complete blood tests, hormonal tests, and urine tests to keep you informed about your health.
                                </p>
                                ...
                                <strong>Choose Pravi Labs in Wadala (East) for trusted and convenient health diagnostics. Book your test today!
                                </strong>
                            </div>
        ...
        <div class="container-card">
            ...
            <div class="card card-image">
                <img src="assets/images/image.png" alt="Image 1" class="slider-image active"
                    class="lazyload">
