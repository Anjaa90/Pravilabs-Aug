                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Vashi, Sector 10 – Near Mini Market, Juhu Nagar</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 10, Vashi, provides accurate diagnostic services, including complete blood tests, urine tests, and hormonal tests, to support your wellness.
                                    With Free Home Blood Collection within 60 minutes, testing is convenient and stress-free.
                               
                                    </p>

                                <p class="about-fore__top__text">Our tailored health check-up packages help you monitor your health with ease, whether for routine care or specific concerns.
                                    Receive fast and precise blood test results online within 3-4 hours, ensuring timely decisions for your health.
                                </p>
                                <strong>Choose Pravi Labs in Sector 10, Vashi – trusted diagnostics at your service. Book your test today!
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Vashi Sector 10</h3>
