                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs in Sanpada, Sector 13 near Palm Beach Road</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 13, Sanpada, offers a wide range of diagnostic services including blood tests, urine tests, and hormonal assessments, all with reliable and precise results. Our free home blood collection service ensures a hassle-free testing experience, making health check-ups simple and convenient.</p>
                                <p class="about-fore__top__text">Choose from our Comprehensive health check-up packages to monitor your well-being and address your unique health needs. With results delivered online in just 3-4 hours, you can make timely and informed decisions for your health.</p>
                                <strong>Book your test with Pravi Labs, Sector 13, Sanpada – trusted diagnostics made easy.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 13</h3>
