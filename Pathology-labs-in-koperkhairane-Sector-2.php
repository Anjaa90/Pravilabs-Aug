                    ...
                    <div class="main-header__bootom__inner">
                        <nav class="main-header__nav main-menu">
                            <ul class="main-menu__list one-page-scroll-menu">
                                ...
                                <li class="scrollToLink"><a href="#testimonial">Testimonial</a>
                                </li>
                                <li class="scrollToLink"><a href="doctors.php">Doctors</a></li>
                                <li class="scrollToLink"><a href="chemists.php">Chemists</a></li>
                                <!-- <li class="scrollToLink"><a href="#blog">Contact Us</a></li> -->
                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs in Kopar khairane, Sector 2 near Vashi Kopar khairane Road</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 2, Kopar Khairane offers a wide range of diagnostic tests, including blood tests, urine tests, and hormonal tests, ensuring reliable and accurate results. Our Comprehensive health check-up packages help you monitor your health and stay proactive.</p>
                                <p class="about-fore__top__text">With our free home blood collection service, testing is easy and convenient, saving you time and effort. Get your test results online within 3-4 hours for quick access to vital health information.</p>
                                <strong>Book your test today with Pravi Labs in Sector 2, Kopar Khairane – your trusted partner for diagnostics.</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in KoparKhairane Sector 2</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs _Vashi Koparkhairane Road.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
