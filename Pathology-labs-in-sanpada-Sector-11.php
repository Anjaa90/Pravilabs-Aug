                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 11 Near Juinagar Railway Station</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 11, Sanpada offers a wide variety of tests, including blood tests, urine tests, and hormonal tests, ensuring reliable and accurate results. Our free home blood collection service makes health testing convenient and hassle-free.</p>
                                <p class="about-fore__top__text">We also provide health check-up packages tailored to your needs, helping you stay on top of your wellness. Get fast blood test results online within 3-4 hours, making it easy to access your health information quickly.</p>
                                <strong>Choose Pravi Labs in Sector 11, Sanpada – your partner in better health!</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 11</h3>
