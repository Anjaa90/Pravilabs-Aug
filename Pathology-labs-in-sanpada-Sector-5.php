                    ...
                    <div class="main-header__inner">
                        ...
                        <nav class="main-header__nav main-menu">
                            <ul class="main-menu__list one-page-scroll-menu">
                                ...
                                <li class="scrollToLink"><a href="chemists.php">Chemists</a>
                                </li>
                        ...
                        <div class="about-fore__left">
                            <div class="about-fore__top">
                                <div class="sec-title text-start wow fadeInUp" data-wow-duration='700ms'>
                                    ...
                                    <!-- /.sec-title__tagline -->
                                    <h1 class="sec-title__title">Pravi Labs Sanpada, Sector 5 Near Gaav Devi Maidan, Sanpada Gaon</h1>
                                    <!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                                <p class="about-fore__top__text">Pravi Labs in Sector 5, Sanpada offers reliable health tests, including blood tests, urine tests, and hormonal tests, to meet all your needs. Our free home blood collection service ensures pickup within 60 minutes, making testing easy for you.</p>
                                <p class="about-fore__top__text">We also provide health check-up packages to help you monitor and manage your wellness. Get fast and accurate blood test results delivered online in just 3-4 hours.</p>
                                <strong>Book your test today with Pravi Labs in Sector 5, Sanpada!</strong>
                            </div>
        ...
        <div class="container-card">
            <div class="card card-content-card">
                <div class="card-content">
                    <h3>Pathology Lab & home blood collection services in Sanpada Sector 5</h3>
            ...
            <div class="card card-image">
                <img src="assets/images/pravilabs _Gaondevi Maidan Sanpada Gaon.jpg" alt="Image 1" class="slider-image active"
                    class="lazyload">
